...
def blur_faces_video(input_video, output_video):
    ...
    print("Video selesai diproses:", output_video)


if __name__ == "__main__":
    blur_faces_video("test_video.mp4", "output_blur.mp4")
